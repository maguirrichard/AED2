...
class No 
{
   ...
   ********************************************/
  public No(Pessoa elemento, No esq, No dir, int nivel) 
  {
...
class AVL
{
  ...
  private No balancear(No no) throws Exception
  {
	if(no != null)
	{
	   ...
	   //Se balanceada
	   if (Math.abs(fator) <= 1) no = no.setNivel();
	   ...
	   }else throw new Exception("Erro fator de balanceamento (" + fator + ") invalido!"); 
