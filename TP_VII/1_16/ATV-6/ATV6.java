...
class Hash {
  ...
  {
      return (((int)elemento*100) % m);
  }

  public int reh(double elemento)
  {
      return ((((int)elemento*100)+1) % m);
  }
  ...
  public void inserir (Municipio elemento)
  {
	...
	if(elemento != null)
	{
	   ...
	   if(tabela[pos] == null)
		 ...
		 pos = reh(elemento.getTemperatura());
		 if(tabela[pos] == null)
		    tabela[pos] = elemento;
	   }
	}
  ...
  public void pesquisar (double elemento)
  {
	...
	int pos = h(elemento);
     ...
     if(tabela[pos] != null && tabela[pos].getTemperatura() == elemento)
	   resp = true;
